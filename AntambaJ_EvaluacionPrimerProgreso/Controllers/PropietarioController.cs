...
namespace AntambaJ_EvaluacionPrimerProgreso.Controllers
{
    public class PropietarioController : Controller
    {
        ...
        public PropietarioController(SQLServerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Edad,Correo,EsDueñoActivo,AntambaJ,DeudaPendiente,FechaRegistro")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Edad,Correo,EsDueñoActivo,AntambaJ,DeudaPendiente,FechaRegistro")] Propietario propietario)
        {
